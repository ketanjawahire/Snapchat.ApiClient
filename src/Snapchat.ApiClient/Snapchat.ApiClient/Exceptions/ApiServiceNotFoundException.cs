...
#pragma warning restore CA1032 // Implement standard exception constructors
    {
        ...
        public ApiServiceNotFoundException(Type serviceType)
            : base(serviceType != null ? $"Snapchat API service of type {serviceType.Name} is not implemented yet. Please contact developer." : "Service of given type is not implemented yet. Please contact developer.")
        {
